...
cap = cv2.VideoCapture("/content/drive/MyDrive/Colab Notebooks/AI_Project_2/video/Don_video_1.mp4")
cap.set(3, width)
cap.set(4, height)

# For static images:
src_image_paths = [
"/content/drive/MyDrive/Colab Notebooks/AI_Project_2/image/kang/kanghodong.jpeg"
]
